...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-body">
      <div class="header">
        <h2>Course Matrix: Assessment and ILOs</h2>
      </div>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th scope="col" rowspan="2">ILOs</th>
            <th scope="col" colspan="2">Written exams (Final/ MT/ Quizzes)</th>
            <th scope="col" colspan="2">Practical / Clinical exam.</th>
            <th scope="col" colspan="2">Oral exam</th>
            <th scope="col" colspan="2">Assignment / Project / Research</th>
            <th scope="col" colspan="2">Requirements (Practical/ clinical)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>
              <table>
                <tr>
                  ...
                  <th>Long Essay Q</th>
                  <th>True & False</th>
                  <th>Modified True & false</th>
                  <th>Short answer Q</th>
                  <th>Match</th>
                  <th>Complete</th>
