...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-body">
      <div class="header">
        <h2>Relationship Matrix of Program’s ILOs and Program Courses</h2>
      </div>

      <table>
        <thead>
          <tr>
            <th scope="col" rowspan="2">NARS</th>
            <th scope="col" colspan="5">Program ILOs</th>
          </tr>
          <tr>
      ...
      <div>
        <label for="name">Program Director:</label>
      ...
      <div class="sidebar close">
        ...
        <ul class="nav-links">
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li>
                <a href="relationshipcourse.html" class="sub-list"
                  >RelationShip matrix for courses</a
                >
              </li>
              <li>
                <a href="relationshipNARS.html" class="sub-list"
