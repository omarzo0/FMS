...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-body">
      <div class="header">
        <h2>Contents of Course File:</h2>
      </div>
      <h3>1-Course specification (template)</h3>
      <h3>2-Course report (template)</h3>
      <h3>3-Curriculum vitae (CV) for all involved in course</h3>
      <h3>4-Semester schedule</h3>
      <h3>5-Office hours</h3>
      <h3>6-Matrices: (3 templates)</h3>
      <h6>a.ILOs versus course content</h6>
      <h6>b.ILOs versus teaching & learning methods</h6>
      <h6>c.ILOs versus assessment methods</h6>
      <h3>7-Samples from student’s assignments and work</h3>
      <h3>8-Blueprint for written exams (template) </h3>
      <h3>9-Rubrics for practical exam</h3>
      <h3>10-Student’s coursework results</h3>
      <h3>11-Student’s feedback</h3>
      <h3>12-Course exams (past 3 years)</h3>
      <h3>13-Exam’s model answers</h3>
      <h3>14-Internal evaluator report (template NAQAAE)</h3>
      <h3>15-External evaluator report (template NAQAAE)</h3>
